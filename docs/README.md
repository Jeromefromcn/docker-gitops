...
| [`deployment-topology/`](deployment-topology/v5.md) | Successive deployment topology snapshots (v1–v5), each recording the full service distribution at that time | When you want to see the overall architecture at some point in time; the highest version number is the newest |
