...
This document: full record of the on-site data, the investigation chain (including the two Helm values layer mistakes I made and corrected myself), the root-cause chain, the remediation process and verification method, and seven open follow-up items, for reuse.
