#!/usr/bin/env bash
# vps_oracle2/inspector-checks/checks/oracle2-docker-stopped-containers.sh
#
# vps-oracle2 counterpart of checks/docker-stopped-containers.sh (same logic and tier), run
...
require_daemon "oracle2-docker-stopped-containers.sh"
