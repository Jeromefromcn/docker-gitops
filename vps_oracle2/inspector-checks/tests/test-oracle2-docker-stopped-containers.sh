#!/usr/bin/env bash
# vps_oracle2/inspector-checks/tests/test-oracle2-docker-stopped-containers.sh — hermetic: docker is a stub
...
check="$SCRIPT_DIR/../checks/oracle2-docker-stopped-containers.sh"
