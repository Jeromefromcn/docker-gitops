#!/usr/bin/env bash
# vps_oracle2/inspector-checks/tests/test-oracle2-docker-unused-networks.sh — hermetic docker stub.
set -uo pipefail
...
check="$SCRIPT_DIR/../checks/oracle2-docker-unused-networks.sh"
