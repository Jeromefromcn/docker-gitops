#!/usr/bin/env bash
# vps_gcp/inspector-checks/tests/test-gcp-docker-stopped-containers.sh — hermetic: docker is a stub
...
check="$SCRIPT_DIR/../checks/gcp-docker-stopped-containers.sh"
