#!/usr/bin/env bash
# vps_gcp/inspector-checks/checks/gcp-docker-unused-networks.sh
#
# vps-gcp counterpart of checks/docker-unused-networks.sh (same logic and tier), run
...
require_daemon "gcp-docker-unused-networks.sh"
