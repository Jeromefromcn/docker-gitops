#!/usr/bin/env bash
# vps_gcp/inspector-checks/checks/gcp-docker-build-cache.sh
#
# vps-gcp counterpart of checks/docker-build-cache.sh (same logic and tier), run
...
require_daemon "gcp-docker-build-cache.sh"
